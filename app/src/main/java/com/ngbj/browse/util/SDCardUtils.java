...
public final class SDCardUtils {
    ...
    public static String getAppRootStoreFileDir(){
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())){
            String path = Environment.getExternalStorageDirectory().getPath()+ FILE_SEP +"reafang"+FILE_SEP;

            String dir = Environment.getExternalStorageDirectory().getPath();
            File file = new File(dir,"reafang");
            if(!file.exists()){
                file.mkdir();
            }
    ...
    public static String getAppStoreImageFileDir(){
        String rootPath = getAppRootStoreFileDir();
        if(rootPath!= null){
            String path = rootPath+"pic"+FILE_SEP;

            String dir = Environment.getExternalStorageDirectory().getPath()+ FILE_SEP +"reafang";
